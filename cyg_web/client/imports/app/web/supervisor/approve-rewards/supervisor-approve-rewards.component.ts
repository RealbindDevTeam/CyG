...
@Component({
    ...
    templateUrl: './supervisor-approve-rewards.component.html',
    styleUrls: ['./supervisor-approve-rewards.component.scss']
})
export class SupervisorApproveRewardsComponent implements OnInit, OnDestroy {
